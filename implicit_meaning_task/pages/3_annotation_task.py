...
samples = read_json_from_file(TASK_INFO["ambistory_task"]["annotation_filepath"])
...
st.session_state.page = "ambistory_task_annotation_page_sample" + str(st.session_state.progress)
