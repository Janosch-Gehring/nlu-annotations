...
from var_sentence_task.common import logic, utils
...
st.session_state.page = "var_sentence_task2_qualification_page_sample" + str(st.session_state.qualification_progress)
...
(Select exactly one checkbox for each story.)
    ...
    samples = core_utils.read_json_from_file(core_utils.TASK_INFO["var_sentence_task2"]["qualification_filepath"])
