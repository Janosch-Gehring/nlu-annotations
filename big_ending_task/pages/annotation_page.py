...
from big_ending_task.common import utils
...
if 0: #user_repository.get_qualification() != 1:
    ...
    question, ending, comment, next_input = utils.print_annotation_schema("annotation", index)
    annotation = {"sentence": question["sentence"], "precontext": question["precontext"], "ending": ending, "meaning": question["displayed_meaning"], "comment": comment}
