...
if st.session_state.user_id == "":
    ...
    informed_consent_page = st.Page(
        "memory_experiment/pages/informed_consent_page.py", title="Memory Experiment", icon="🧠", url_path="informed_consent",default=False
    )
else:
    informed_consent_page = st.Page(
        "memory_experiment/pages/informed_consent_page.py", title="Memory Experiment", icon="🧠", url_path="informed_consent",default=True
    )

presentation_page = st.Page(
    "memory_experiment/pages/presentation_page.py", title="Presentation Phase", icon="🧠", url_path="presentation_phase"
)

recall_page = st.Page(
    "memory_experiment/pages/recall_page.py", title="Recall", icon="🔍", url_path="recall_phase"
)

recognition_page = st.Page(
    "memory_experiment/pages/recognition_page.py", title="Recognition", icon="🔍", url_path="recognition_phase"
)

truthjudgement_page = st.Page(
    "memory_experiment/pages/truthjudgement_page.py", title="Credibility", icon="🔍", url_path="credibility_phase"
)
...
distractor_page = st.Page(
    "memory_experiment/pages/distractor_page.py", title="Distractor", icon="🔍", url_path="distractor_phase"
)
...
experiment_description_page = st.Page(
    "memory_experiment/pages/Experiment_description_page.py", title="Experiment Description", icon="🔍", url_path="experiment_description"
)
