...
**Your task is to write ambiguous sentences**. A sentence is ambiguous if there are multiple ways to understand it. 
...
**You can also skip sentences.** There is no limit to how often you can skip, and there is no punishment for skipping. Feel free to skip as often as you want. We encourage skipping when:
- You cannot think of a good sentence
- You are not familiar with the word or one of the displayed meanings
- The word senses displayed are very similar, or the difference is not obvious to you

You have to write five sentences to clear the task.
