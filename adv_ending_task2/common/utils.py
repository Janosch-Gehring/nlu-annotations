...
with open("adv_ending_task2/resources/tutorial_text.json", "r") as f:
...
def print_annotation_schema(subtask: str, index: int) -> tuple:
    ...
    if subtask == "qualification":
        samples = read_json_from_file(TASK_INFO["adv_ending_task"]["qualification_filepath"])
        ...
        if subtask == "annotation":
            ...
            samples = read_json_from_file(TASK_INFO["adv_ending_task2"]["tutorial_filepath"])
