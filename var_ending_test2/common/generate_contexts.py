...
OUTPUT_FILEPATH = "var_ending_test2/resources/new_samples.json"
NUMBER_OF_GROUPS = 15
...
def generation_prompt(sample, position=2, part="precontext"):
    ...
    prompt = f"""
        The given sentence "{sample["sentence"]}" is part of a to-be-constructed story. 
        ...
        {{"beginning": "some sentences...", "sentence": {sample["sentence"]}, "ending": "some sentences..."}}
...
if __name__ == "__main__":
    with open("var_ending_test2/resources/homonyms.json", "r") as f:
